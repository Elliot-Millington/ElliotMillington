...
- icon: envelope
  icon_pack: fas
  link: "mailto:e.millington.1@research.gla.ac.uk" #For a direct email link, use "mailto:test@example.org".
- icon: twitter
  icon_pack: fab
  link: https://twitter.com/E_Millington
- icon: osf
  icon_pack: ai
  link: https://osf.io/29pca
- icon: orcid
  icon_pack: ai
  link: https://orcid.org/0000-0002-2580-4035
- icon: github
  icon_pack: fab
  link: https://github.com/ElliotMillington
